...
POINTS_1="format=lawnmower,label=survey,x=55,y=-120,width=205,height=110,lane_width=15,rows=north-south,degs=0"
...
nsplug meta_kf.moos targ_$VNAME1.moos -f WARP=$TIME_WARP  \
   VNAME=$VNAME1      START_POS=$START_POS1                    \
   VPORT="9001"       SHARE_LISTEN="9301"                      \
   VTYPE=UUV          SENSOR_PD=$SENSOR_PD_1                   \
   SHORE_IP=$SHORE_IP SHORE_LISTEN=$SHORE_LISTEN               \
