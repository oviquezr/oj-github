...
#-------------------------------------------------------
VNAME1="oscar"           # The first vehicle Community
...
nsplug meta_vehicle.moos targ_oscar.moos -f WARP=$TIME_WARP \
    VNAME=$VNAME1          SHARE_LISTEN="9303"              \
...
nsplug meta_vehicle.bhv targ_oscar.bhv -f VNAME=$VNAME1     \
...
pAntler targ_oscar.moos >& /dev/null &
#sleep 0.25
