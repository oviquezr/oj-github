...
printf "...alpha.moos..."
pAntler alpha.moos --MOOSTimeWarp=$WARP >& /dev/null &
printf "...bravo.moos..."
pAntler bravo.moos --MOOSTimeWarp=$WARP >& /dev/null &
printf "...shoreside.moos..."
pAntler shoreside.moos --MOOSTimeWarp=$WARP >& /dev/null &
